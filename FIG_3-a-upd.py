...
ph, = ax2.plot(times_1, eta_1_FE/L, linewidth = 1, label = r'UE $\omega_p = 18.0$') #, $\Phi_0 = 0.2$
ax2.plot(times_1, eta_1_LC/L, color = ph.get_color(), linewidth = 4, alpha = 0.5, label = r'LC')
ax2.plot(times_1_AC, eta_1_AC/L, color = ph.get_color(), linewidth = 2, linestyle = 'dashed', label = r'AC')
...
#ax2.plot(times_1[::400], eta_1_LC_DOUBLE[::400]/L, linestyle = (0, (2, 3)), linewidth = 3, alpha = 0.5, color = ph.get_color())
#ax2.plot(times_1_AC[100::400], eta_1_AC[100::400]/L, linestyle = 'dashed', color = ph.get_color())

phh, = ax2.plot(times_2, eta_2_FE/L, linewidth = 1, label = r'$\omega_p = 19.1$') #, $\Phi_0 = 0.2$
ax2.plot(times_2, eta_2_LC/L, color = phh.get_color(), linewidth = 4, alpha = 0.5, label = r'LC')
ax2.plot(times_2_AC, eta_2_AC/L, color = phh.get_color(), linewidth = 2, linestyle = 'dashed', label = r'AC')

#ax2.plot(times_2[200::400], eta_2_LC_DOUBLE[200::400]/L, marker = 'o', markersize = 5 , color = phh.get_color(), linestyle = '', label = r'LC')
#ax2.plot(times_2_AC[300::400], eta_2_AC[300::400]/L, marker = '*', markersize = 10 , color = phh.get_color(), linestyle = '', label = r'AC')
#ax2.plot(times_2[200::400], eta_2_LC_DOUBLE[200::400]/L, color = phh.get_color(), linewidth = 3, alpha = 0.5, label = r'LC')
#ax2.plot(times_2_AC[300::400], eta_2_AC[300::400]/L, color = phh.get_color(), linestyle = 'dashed', label = r'AC')
...
fig.savefig(path + f'/fig-3-a_L{L}.pdf', format='pdf', bbox_inches='tight', dpi=dpi)
