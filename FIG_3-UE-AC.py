# WARNING!
# {LINE 24 & LINE 30 & LINE 158} - angular frequency, amplitude, and eta_sq_max are introduced in the code!
...
phi_L_2 = np.arcsin(Q_L*(Eta_sq_L-asymt_goal)/(eta_sq_max*Q_norm))[end_in_sum:]
...
output_dict['1_AC_phi'] = phi_L(times)
output_dict['1_AC_eta'] = Eta_sq_L
output_dict['1_AC_Q'] = Q_L
output_dict['1_AC_derivative'] = derivative_L
output_dict['1_AC_H'] = H_L
...
output_dict['1_AC_eta_DOUBLE'] = Eta_double_evolution
...
output_dict['2_AC_phi'] = phi_L(times)
output_dict['2_AC_eta'] = Eta_sq_L
output_dict['2_AC_Q'] = Q_L
output_dict['2_AC_derivative'] = derivative_L
output_dict['2_AC_H'] = H_L
...
output_dict['2_AC_eta_DOUBLE'] = Eta_double_evolution

print('4.5th 1 is written')

np.save(f'UE_vs_AC_dict_L{L}_18.0-0.2_19.1-0.2_t~o~18.0.npy', output_dict)