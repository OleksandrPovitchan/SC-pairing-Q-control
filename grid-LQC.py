...
from parameters import start_from_exp_5_6 as start_from
from parameters import threads_exp_5_6 as threads
...
output_path = './grid-LQC/L{}-LQC-{}-{}-({})_{}-{}-({})'.format(L, omega_min_numb, omega_max_numb, omega_step_numb, A0_min, A0_max, A0_step)
...
while i < omega_points*Phi0_points:
    ...
    # LYAPUNOV # # LYAPUNOV # # LYAPUNOV # # LYAPUNOV # # LYAPUNOV #
    ...
    Eta_sq_lyapunov = obs_vs_time(psi_t, times, op_dict)['Eta_sq']

    np.savetxt(output_path + '/L{}-LQC-eta_sq-{}-{}-({})_{}-{}-({})_{}.txt'.format(L ,omega_min_numb, omega_max_numb, omega_step_numb, A0_min, A0_max, A0_step, i), Eta_sq_lyapunov)
