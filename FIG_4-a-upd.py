...
ax2.plot(times, eta_1_LC_DOUBLE/L, label = 'LC', linestyle = (0, (2, 3)), linewidth = 3, color = 'black')

ax2.plot(times, eta_final/L, color = 'red', label = r'$\rm{LC^{(sat.)}}$')
...
ins_ax.plot(times_in, eta_final_in/L, color = 'red', label = r'$\rm{LC^{(sat.)}}$')
...
fig.savefig(path + f'/fig-4-a_L{L}.pdf', format='pdf', bbox_inches='tight', dpi=dpi)
