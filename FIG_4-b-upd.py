...
ax2.plot(times, eta_1_LC_DOUBLE/L, label = 'AC', linestyle = (0, (2, 3)), linewidth = 3, color = 'black')
#linestyle = 'dashed'
ax2.plot(times, eta_final/L, color = 'red', label = r'$\rm{AC^{(sat.)}}$')
...
fig.savefig(path + f'/fig-4-b_L{L}.pdf', format='pdf', bbox_inches='tight', dpi=dpi)
