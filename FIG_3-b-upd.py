...
fig_b, (ax3) = plt.subplots(1, 1, figsize=(8, 4))

read_dictionary = np.load(f'excited_picture_LC_L{L}.npy',allow_pickle='TRUE').item()
...
cbar = fig_b.colorbar(scatter1, cax=cax)

fontsize = 18

ax3.text(1, 0.98, r'(b)', transform=ax3.transAxes, fontsize=fontsize, 
...
dpi=600
#fig_b.savefig(path + f'/fig-1-a_L{L}_{dpi}.png', format='png', bbox_inches='tight', dpi=dpi)
fig_b.savefig(path + f'/fig-3-b_L{L}.pdf', format='pdf', bbox_inches='tight', dpi=dpi)
