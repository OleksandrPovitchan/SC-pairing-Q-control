# calculates evolution under unperturbed pulse 17.0-0.4
# exports start and stop time
# calculates evolution under asymptotic control ('derivative activation condition')
...
t_s = Time.t_s
t_f = Time.t_f
time_points_dict = {'t_s': t_s, 't_f': t_f}
np.save(f'{omega_p}-{Phi_0}-t_s-t_f.npy', time_points_dict)
...
print('import of the operators: DONE')
...
print('defining of the unitary: DONE')
