### | 18.0 | 0.2 | ### | 19.1 | 0.2 | ###
### be aware: the smoothing protocol is done exclusively for sigma = 3 ###
...
t_s = 0.0; t_f_numb = 30; t_r_numb = 25; step_divisor = 50
...
np.save(f'r_customisation/L{L}_[{omega_p}]_[{Phi_0}]_[{step_divisor}]_UE_[{t_r_numb}].npy', first_dict) 
...
np.save(f'r_customisation/L{L}_[{omega_p}]_[{Phi_0}]_[{step_divisor}]_LC_[{t_r_numb}].npy', second_dict) 
...
np.save(f'r_customisation/L{L}_[{omega_p}]_[{Phi_0}]_[{step_divisor}]_smooth_[{t_r_numb}].npy', third_dict)
...
np.save(f'r_customisation/L{L}_[{omega_p}]_[{Phi_0}]_[{step_divisor}]_tech_[{t_r_numb}].npy', fourth_dict)
