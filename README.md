...
To obtain *FIG. 7.*, one needs to execute the following sequence of scripts: *r_smooth_pulse-to-custom.py* -> *r_pulse_customisation.py* -> *r_evolve_from_pulse.py* -> *FIG_7.py*.
